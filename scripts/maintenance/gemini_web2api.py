...
import re
import os
# Workaround for httpx InvalidURL error caused by ::1/128 in NO_PROXY on Windows
if "NO_PROXY" in os.environ:
    os.environ["NO_PROXY"] = os.environ["NO_PROXY"].replace("::1/128", "::1")
...
DEFAULT_CONFIG = {
    ...
    "gemini_bl": "boq_assistant-bard-web-server_20260609.21_p0",
    "auth_user": None,
    "xsrf_token": None,
